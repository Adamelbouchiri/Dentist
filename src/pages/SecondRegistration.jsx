...
export const SecondRegistration = () => {
  ...
  return (
    <div className="flex h-screen">
      <div className="p-10 bg-white w-1/3 border-r border-r-primary-500">
        <img src="/images/logo.png" alt="register-two" />
        <h1 className="pb-4 pt-10 text-3xl lg:text-4xl font-bold leading-10 lg:leading-12">
          Take care of your Dents health
        </h1>
